package nus.edu.iss.workshop11latest.workshop11latest;
...
public class Workshop11latestApplication {
	// Instantiate the logger
	private static final Logger logger = LoggerFactory.getLogger(Workshop11latestApplication.class);
	// The default fallback port used by the spring boot application
	private static final String DEFAULT_PORT = "3000";
	public static void main(String[] args) {
		logger.info("Workshop 11");
		// init the apring app
		SpringApplication app = new SpringApplication(Workshop11latestApplication.class);
